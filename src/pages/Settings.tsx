  ...
  return (
    <div className="flex h-screen font-sans antialiased bg-blue-50 text-gray-900">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {/* Top Navigation */}
        <PageHeader mainTitle="Settings" mainTitleHighlight="Page" description="Manage work units and their configurations within the system." icon={<Settings />} isMobile={isMobile} toggleSidebar={toggleSidebar} />
