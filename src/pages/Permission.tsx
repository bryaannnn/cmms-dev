        ...
        <main className="flex-1 overflow-y-auto p-4 md:p-6">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex justify-between items-center mb-6">
              ...
              {user?.role?.includes("admin") && ( // Hanya admin yang bisa menambah permission
                ...
                <table className="min-w-full divide-y divide-blue-100">
                  <thead className="bg-blue-50">
                    <tr>
                      ...
                      {user?.role?.includes("admin") && ( // Hanya admin yang bisa melakukan tindakan
                  ...
                  <tbody className="bg-white divide-y divide-blue-50">
                    {permissions.map((permission) => (
                      <tr key={permission.id} className="hover:bg-gray-50 transition-colors duration-150">
                        ...
                        {user?.role?.includes("admin") && ( // Hanya admin yang bisa melihat tindakan
