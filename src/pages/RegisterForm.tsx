...
//         <form onSubmit={handleSubmit} className="relative w-full bg-white rounded-lg shadow-sm border border-gray-100 p-8 sm:p-10 md:p-12" aria-label="Registration Form">
//           {/* Logo */}
...
//           <p className="text-sm text-gray-500 text-center mb-8">Join us to access our pharmaceutical services</p>

//           {error && (
//             <div role="alert" className="mb-6 text-sm text-red-700 bg-red-50 border border-red-100 px-4 py-3 rounded-md flex items-start">
...
//                   required
//                   minLength={8}
//                   className="w-full px-4 py-2.5 text-sm rounded-md border border-gray-300 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-colors pr-10"
//                 />
//                 <button type="button" onClick={togglePasswordVisibility} className="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-500 hover:text-gray-700" aria-label={showPassword ? "Hide password" : "Show password"}>
...
//                 .
//               </p>
//               <p className="text-xs text-gray-500 text-center mt-2">© {new Date().getFullYear()} PT Widatra Bhakti. All rights reserved.</p>
//             </div>
//           </div>
//         </form>
//       </div>
