type ProjectEnvVariablesType = Pick<ImportMetaEnv, "VITE_REACT_API_URL" | "VITE_BACKEND_API_URL">;
...
export const getProjectEnvVariables = (): {
  ...
  return {
    envVariables: {
      VITE_REACT_API_URL: !projectEnvVariables.VITE_REACT_API_URL.includes("VITE") ? projectEnvVariables.VITE_REACT_API_URL : import.meta.env.VITE_REACT_API_URL,

      VITE_BACKEND_API_URL: !projectEnvVariables.VITE_BACKEND_API_URL.includes("VITE") ? projectEnvVariables.VITE_BACKEND_API_URL : import.meta.env.VITE_BACKEND_API_URL,
