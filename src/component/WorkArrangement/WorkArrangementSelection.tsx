...
import {
  Users, // Icon for Group
  Clock, // Icon for Shift
  ChevronRight,
  Sun,
  Moon,
  Bell,
  ...
  Settings,
  LogOut,
  Briefcase, // For header title icon (representing work arrangement)
  ChevronDown,
} from "lucide-react";
...
const WorkArrangementSelection: React.FC = () => {
  ...
  return (
    <div className="flex h-screen font-sans antialiased bg-blue-50 text-gray-900">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {/* Header section */}
         <PageHeader mainTitle="Work Arrangement" mainTitleHighlight="Page" description="Manage work shifts and their configurations within the system." icon={<Users />} isMobile={isMobile} toggleSidebar={toggleSidebar} />
        ...
        <main className="flex-1 overflow-y-auto p-4 md:p-6 custom-scrollbar bg-gray-50">
          <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3 }} className="mb-6 text-center">
            <h1 className="text-2xl md:text-3xl font-bold text-gray-900">Select Work Arrangement Type</h1>
            <p className="text-gray-600 mt-2">Choose how you want to manage work groups and shifts.</p>
          </motion.div>
...
export default WorkArrangementSelection;
