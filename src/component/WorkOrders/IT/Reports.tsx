...
//   const { user, hasPermission, getWorkOrdersIT, getUsers } = useAuth();
//   const navigate = useNavigate();
...
//                         <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{order.device_information}</td>
//                         <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">
//                           <div className="flex items-center">
//                             <img
//                               src={
//                                 order.assigned_to_avatar ||
//                                 `https://api.dicebear.com/7.x/initials/svg?seed=${users.find((u) => u.id === order.assigned_to)?.name || "N/A"}&backgroundColor=0081ff,3d5a80,ffc300,e0b589&backgroundType=gradientLinear&radius=50`
//                               }
//                               alt="Avatar"
//                               className="w-8 h-8 rounded-full mr-3"
//                             />
//                             {users.find((u) => u.id === order.assigned_to)?.name || "N/A"}
//                           </div>
//                         </td>
...
//                         <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium text-gray-700">{users.find((u) => u.id === order.known_by)?.name || "N/A"}</td>
//                       </motion.tr>
//                     ))}
//                   </AnimatePresence>
//                 </tbody>
