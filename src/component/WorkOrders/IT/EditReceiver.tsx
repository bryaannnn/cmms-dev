...
const EditReceiver: React.FC = () => {
  ...
  useEffect(() => {
    const shouldShowAssignedTo = formData.handling_status === "Escalated" || formData.handling_status === "Vendor Handled";
    setShowAssignedToField(shouldShowAssignedTo);

    // Reset assigned_to_id jika status berubah dari Escalated/Vendor Handled
