...
import { Clipboard, Clock, Wrench, CheckCircle, ChartBar, BarChart2, TrendingUp, Settings, Bell, ChevronDown, ChevronRight, Moon, Sun, UserIcon, Info, AlertTriangle, Calendar, LogOut } from "lucide-react";
  ...
  return (
    <div className={`flex h-screen font-sans antialiased bg-blue-50`}>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <PageHeader mainTitle="Machine History" mainTitleHighlight="Machine History" description="Manage activities and their configurations within the system." icon={<ChartBar />} isMobile={isMobile} toggleSidebar={toggleSidebar} />
