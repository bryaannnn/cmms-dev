...
const WorkLocationSelection: React.FC = () => {
  ...
  return (
    <div className="flex h-screen font-sans antialiased bg-blue-50 text-gray-900">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {/* Header section */}
        <PageHeader mainTitle="Work Location" mainTitleHighlight="Page" description="Manage work shifts and their configurations within the system." icon={<MapPin />} isMobile={isMobile} toggleSidebar={toggleSidebar} />
        ...
        <main className="flex-1 overflow-y-auto p-4 md:p-6 custom-scrollbar bg-gray-50">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-6 max-w-5xl mx-auto py-8">
            ...
            <motion.div
              ...
              whileHover={{ y: -5 }}
              whileTap={{ scale: 0.98 }}
              onClick={() => handleCardClick("/worklocation/workarea")}
            >
              <MapPin size={64} className="text-blue-600 mb-4" />
              <h3 className="text-2xl font-bold text-gray-900 mb-2">Work Area</h3>
              <p className="text-gray-700 mb-4">Manage and define specific work areas within your facilities.</p>
              <span className="text-blue-600 font-semibold flex items-center">
                Go to Work Area <ChevronRight size={18} className="ml-1" />
              </span>
            </motion.div>
...
export default WorkLocationSelection;
