      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="bg-white border-b border-gray-100 p-4 flex items-center justify-between shadow-sm sticky top-0 z-30">
          <div className="flex items-center space-x-4">
            ...
            <LifeBuoy className="text-xl text-blue-600" />
            <h2 className="text-lg md:text-xl font-bold text-gray-900">Service Management</h2>
          </div>
        ...
        <main className="flex-1 overflow-y-auto p-4 md:p-6 custom-scrollbar bg-gray-50">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-6 max-w-4xl mx-auto py-8">
            ...
            <motion.div
              ...
              whileHover={{ y: -5 }}
              whileTap={{ scale: 0.98 }}
              onClick={() => handleCardClick("/service/servicegroup")}
            >
            ...
            <motion.div
              ...
              whileHover={{ y: -5 }}
              whileTap={{ scale: 0.98 }}
              onClick={() => handleCardClick("/service/servicecatalogue")}
            >
