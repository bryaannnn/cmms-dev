...
function mapApiToMachineHistoryRecord(apiData: any): MachineHistoryRecord {
  return {
    ...
    date: apiData.date,
    shift: apiData.shift?.name || apiData.shift || "-",
    group: apiData.group ?? { id: "-", name: "-" },
    unit: apiData.unit ?? { id: "-", name: "-" },
    mesin: apiData.mesin ?? { id: "-", name: "-" },
    ...
    itemTrouble: apiData.itemtrouble?.name || apiData.itemtrouble || "-",
    jenisGangguan: apiData.jenis_gangguan || "",
    bentukTindakan: apiData.bentuk_tindakan || "",
    perbaikanPerawatan: "",
    rootCause: apiData.root_cause || "",
    jenisAktivitas: apiData.jenisaktifitas?.name || apiData.jenisaktifitas || "-",
    kegiatan: apiData.kegiatan ?? { id: "-", name: "-" },
    kodePart: apiData.kode_part ?? "",
    sparePart: apiData.spare_part ?? "",
    idPart: apiData.id_part ?? "",
    jumlah: apiData.jumlah ?? 0,
    unitSparePart: apiData.unitsp?.name || apiData.unitsp || "-",
